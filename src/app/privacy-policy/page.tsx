...
export default function PrivacyPolicyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 w-full prose prose-slate">
      ...
      <p>At KagazKit, accessible from kagazkit.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by KagazKit and how we use it.</p>

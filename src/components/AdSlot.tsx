...
export default function AdSlot({ format = 'horizontal', slotId = '1234567890', className = '' }: AdSlotProps) {
  ...
  return (
    <div className={`w-full overflow-hidden flex justify-center items-center bg-slate-50 rounded-xl border border-dashed border-slate-200 my-8 ${minHeightClass} ${className}`}>
      {/* Dev placeholder text to show where the ad will appear */}
      <span className="text-xs text-slate-400 uppercase tracking-widest font-medium">Advertisement</span>
